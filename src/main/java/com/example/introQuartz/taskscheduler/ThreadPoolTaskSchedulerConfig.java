package com.example.introQuartz.taskscheduler;
...
@Configuration
@ComponentScan(basePackages = "com.example.introQuartz.taskscheduler", basePackageClasses = { ThreadPoolTaskSchedulerExamples.class })
